	...
	function v_get(){
		form_data = '&vidget=u';
		send_data = form_data;
		seats = ajax_data('app/r_seat_sel.php', 'rides', send_data);
		//console.log(vee);
	}
	function seats_get(){
		form_data = '&seats=s';
		send_data = form_data;
		seats = ajax_data_var('app/r_seat_sel.php', seats, send_data);
		//console.log('i am ' + seats);
	}
	function pass_get(){
		form_data = '&pass=p';
		send_data = form_data;
		pass = ajax_data_var('app/r_seat_sel.php', pass, send_data);
		//console.log(pass);
	}
	...
	function bt_bus_cont(){
		...
		if(seat_array ==''){
			...
			ajax_data_red('app/r_seat_sel.php', 'error', send_data);
		}
	}
